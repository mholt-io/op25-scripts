...
class OP25_GUI(threading.Thread):
    ...
    def OP25CMD(self, type, city, group, playing):
        ...
        if type is 'play':
            ...
            os.system("pkill -f ./rx.py")
            os.system("cd "+OP25_Path+"; ./rx.py -n --args 'rtl' -N 'LNA:47' -S 2000000 -o 1.25e3 -q -1 -T "+TSV_Files_Path+"/"+city.lower()+"/"+group.lower()+".tsv -V -2 -U -v 5 2> "+OP25_Log_Path+"/stderr.2 -l 'http:0.0.0.0:8080'&")
